...
public class HippoDecode2026_rpgv4 extends LinearOpMode {
...
//import com.qualcomm.robotcore.hardware.DcMotor;
    ...
    public void runOpMode() {
        ...
        telemetry.update();
       //flywheel2
        flywheel2 = hardwareMap.get(DcMotorEx.class, "flywheel1");
        ...
        //FlywheelShoot flywheel = new FlywheelShoot(flywheel2, 0.016, 0.0, 0.0001, 0.00042);
        ...
        while (opModeIsActive()) {
            ...
            double currentTPS = flywheel1.getVelocity();//do i need to add flywheel 2 here?
